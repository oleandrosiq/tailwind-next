...
export default function Home() {
	return (
		<Fragment>
			<h1 className="font-mediumtext-zinc-900 text-3xl">Settings</h1>
				...
				<form id="settings" action="" className="mt-6 flex w-full flex-col gap-5 divide-y divide-zinc-200">
					<div className="grid-cols-form grid gap-3">
						...
						<div className="grid grid-cols-2 gap-6">
							...
							<Input.Root>
								<Input.Control defaultValue="Siqueira" />
							</Input.Root>
						</div>
					</div>
					...
					<div className="grid-cols-form grid gap-3 pt-5">
						...
						<Input.Root>
							...
							<Input.Control id="email" type="email" defaultValue="leandrosiqueira.dev@hotmail.com" />
						</Input.Root>
					</div>
					...
					<div className="grid-cols-form grid gap-3 pt-5">
						...
						<Select placeholder="Select a timezone...">
							<SelectItem text="Pacific Standard Time (PST) (UTC−08:00)" value="utc8" />
						...
						<div className="space-y-3">
							<div className="grid grid-cols-2 gap-3">
								...
								<div className="flex items-center gap-1">
									...
									<Button type="button" variant="ghost">
										<ListOrdered strokeWidth={3} className="h-4 w-4 text-zinc-500" />
									</Button>
								</div>
							</div>
							...
							<span className="text-zinc-500">max 275 characters</span>
						</div>
					</div>

					<div className="grid-cols-form grid gap-3 pt-5">
						<label htmlFor="portfolio-projects" className="text-sm font-medium text-zinc-700">
							Portfolio projects
